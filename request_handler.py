...
from utils.llm_helper import call_bedrock_llm
from MySQLChatbot.mcp_mysql import mysql_query, get_table_schema, get_all_tables_in_db

# Initialize Bedrock client for Claude Opus 4.1
import boto3
import json
...
class ClaudeOpusClient:
    ...
    def generate_text(self, prompt):
        """
        Generate text using Claude Opus 4.1 via AWS Bedrock
        """
        try:
            body = {
            ...
            logging.error(f"Error calling Claude Opus: {e}")
            raise

claude_client = ClaudeOpusClient()
...
"""
    ...
    response = claude_client.generate_text(prompt)
